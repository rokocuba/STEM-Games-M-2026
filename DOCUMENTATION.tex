...
\section{Podaci i priprema skupa}
...
\begin{itemize}
    \item \texttt{gpt-slop-2}: \url{https://huggingface.co/datasets/trentmkelly/gpt-slop-2/},
    \item GriD Reddit skupovi: \url{https://github.com/madlab-ucr/GriD/tree/main/reddit_datasets},
    \item \texttt{gpt-slop}: \url{https://huggingface.co/datasets/trentmkelly/gpt-slop}.
\end{itemize}
...
\[
70\% \rightarrow \texttt{train.csv}, \qquad
15\% \rightarrow \texttt{dev.csv}, \qquad
15\% \rightarrow \texttt{test.csv}.
\]

Skup \texttt{train.csv} koristi se za učenje baznih modela i završnog meta-modela, \texttt{dev.csv} za razvojno vrednovanje i usporedbu modela, a \texttt{test.csv} za završnu provjeru generalizacije na odvojenim primjerima.
